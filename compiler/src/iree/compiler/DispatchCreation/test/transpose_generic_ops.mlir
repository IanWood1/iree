// RUN: iree-opt --split-input-file --verify-diagnostics --iree-dispatch-creation-transpose-generic-ops --iree-dispatch-creation-canonicalize -cse --mlir-print-local-scope %s | FileCheck %s

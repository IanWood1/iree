...
// is not affine (index values come from a tensor). This pattern clones a
// "BitExtendOp" into the region of the `linalg.generic` so the bit extension
// occurrs in the when the value is extracted
